...
## Integrate in your Android app (0.2.0)
...
```gradle
dependencies {
    implementation 'com.github.godsarmy.mlkit-html-translator-android:library:0.2.0'
}
```

### Option B: source-module integration (tag `0.2.0`)

If you prefer source integration, check out tag `0.2.0` and include this repo's `library/` module in your app workspace, then depend on it as a Gradle project module.
